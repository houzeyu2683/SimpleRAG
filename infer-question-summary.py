...
for database in loop:
    ...
    evaluation.activateRetrieval()
    evaluation.activateModel()
    evaluation.activateChain()
    evaluation.activateCategory()
    
    evaluation.inferSummary(top=3)
    evaluation.writeSummary()
