# Industrial Computer Flex ATX Series
## 350W Multiple Output Active PFC Data Sheet
...
- INTEL® standard Flex ATX (1U) form factor.
- Meet 80+gold and support 150% peak power.
...
| Rated current | 29A | 15A | 16A | 0.3A | 3A |
...
| Standby power saving (min.) | Pin<1W at 5Vsb/0.1A; Pin<0.5W at Po=0.23W (at REM_OFF, efficiency>45%) |
...
| Parameter | Value |
|---|---|
| Dimension | 150.0(L) × 81.5(W) × 40.5(H) mm |
...
(Refer to below drawing for case openings)
